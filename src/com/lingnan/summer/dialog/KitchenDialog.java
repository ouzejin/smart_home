...
public class KitchenDialog extends JDialog implements ActionListener {
	private JPanel dnamePanel, tidPanel, locationPanel, paramPanel, opePanel,
			statusPanel;// status 默认为待机0
	...
	public KitchenDialog(JFrame parent, KitchenView kitchenView) {
		super(parent, "添加");
	...
	public KitchenDialog(JFrame parent, KitchenView kitchenView, Device device) {
